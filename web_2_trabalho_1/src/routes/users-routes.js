...
import { deletarUsuario, formularioEdicao, mostraListaUsuarios , editarUsuario, exportarCSV} from "../controller/users-controller.js";
...
usersRouter.get('/export', exportarCSV);
